...
The final iteration is a manually tuned random forsest classifier with >95% accuracy and >64% recall.  It uses the historic biological, behavioral and environmental data collected to predict those who would test postive for COVID-19.
